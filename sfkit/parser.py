...
def get_parser() -> argparse.ArgumentParser:
    ...
    networking = subparsers.add_parser(
        "networking",
        help="Set up the networking, including your IP address and any relevant ports",
    )
    ...
    subparsers.add_parser(
        "generate_keys", help="Generate your public and private cryptographic keys"
    )
    registerdataparser = subparsers.add_parser(
        "register_data",
        help="Register and validate your data.",
        description="Register and validate your data.",
    )
    ...
    runprotocol.add_argument(
        "--demo", default=False, help="Run the demo protocol", action="store_true"
    )
    runprotocol.add_argument(
        "--visualize_results",
        default="",
        help="Visualize the results in the UI (``Yes`` or ``No``) (default is ``No``)",
    )
    runprotocol.add_argument(
        "--results_path",
        default="",
