# sourcery skip: avoid-single-character-names-variables, require-parameter-annotation, require-return-annotation, snake-case-functions

from sfkit.encryption.mpc.random_number_generator import PseudoRandomNumberGenerator


def test_PseudoRandomNumberGenerator(mocker):
    prng = PseudoRandomNumberGenerator(b"\x00" * 32)
    for _ in range(10):
        prng.next()
